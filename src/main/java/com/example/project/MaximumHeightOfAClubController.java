...
public class MaximumHeightOfAClubController {

    @FXML
    TextField clubNameTextField;

    public void onSearchMaximumHeightOfClubButtonClicked(ActionEvent actionEvent) {
        String clubName = clubNameTextField.getText().trim();
        List<Player> players = playerManagement.maxHeightPlayer(clubName);
