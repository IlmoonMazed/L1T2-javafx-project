...
public class MaximumSalaryOfAClubController {

    @FXML
    TextField clubNameTextField;

    public void onSearchMaximumSalaryOfClubButtonClicked(ActionEvent actionEvent) {
        String clubName = clubNameTextField.getText().trim();
        List<Player> players = playerManagement.maxSalaryPlayer(clubName);
